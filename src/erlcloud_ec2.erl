...
%%
%%
-spec(authorize_security_group_ingress ({atom, string()}, ec2_ingress_spec()) -> ok | {error, any()}).
...
-spec(authorize_security_group_ingress ({atom, string()}, ec2_ingress_spec() | [ vpc_ingress_spec() ], aws_config()) -> ok | {error, any()}).
